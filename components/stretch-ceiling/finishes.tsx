  ...
  const finishes = [
    {
      id: "glossy",
      name: "מבריק",
      image: "/images/stretch-finish-glossy.jpg",
      description:
        "גימור מבריק וחלק היוצר קול, משקף אור ומרחב, ומוסיף דרמטיות וקסם. הברק החזק משקף את הרהיטים ותמונות מהחדר. גימור זה מעניק תחושה של יוקרה וגדלנות.",
      use:
    ...
    },
    {
      id: "satin",
      name: "סאטן",
      image: "/images/stretch-finish-satin.jpg",
      description:
        "גימור בעל ברק רך וקלוש, המאזנת בין מבריק למט. הברק השעוך יוצר תחושה אלגנטית ללא בריקות קשות. נראה אלגנטי ויומיומי בו-זמנית.",
      use:
    ...
    },
    {
      id: "matte",
      name: "מט",
      image: "/images/stretch-finish-matte.jpg",
      description:
        "גימור לא מבריק וגדול, שנראה דומה לתקרת גבס קלאסית. הגימור הרך יוצר תחושה של דומיום וריחוק. לא משקף אור, ולכן נראה שקט ומשלים.",
      use:
